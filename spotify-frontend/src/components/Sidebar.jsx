    ...
    return (
        <div className='w-[25%] h-full flex-col gap-2 text-white hidden lg:flex'>
            ...
            <div className="bg-[#121212] h-[85%] rounded-2xl">
                ...
                <div className="p-4 bg-[#242424] m-2 rounded-xl font-semibold flex flex-col items-start justify-start gap-1 pl-4">
                    <h1>Create your first playlist</h1>
                    <p className='font-light'>It&apos;s easy we will help you</p>
                    <button className='px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4'>Create Playlist</button>
                </div>
                <div className="p-4 bg-[#242424] m-2 rounded-xl font-semibold flex flex-col items-start justify-start mt-4 gap-1 pl-4">
